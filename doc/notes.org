...
** Help file creation
   ...
   - Save buffer to help.html in assets directory
...
*** How to use EP Coding
    ...
    - Use the *Device Wizard* (icon is a street sign with curve ahead)
...
*** Acknowledgements
    ...
    - Website: [[http://www.epstudiossoftware.com][www.epstudiossoftware.com]]
* Limitations
  - Code descriptions are paraphrased
...
* Preparing new version -- IMPORTANT!
  ...
  - refresh eclipse epcoding
  - make/sign epcoding.apk, save it in dev/epcodingapp/later_verisons/
