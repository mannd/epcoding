...
*** Replace PPM or ICD
    ...
    - Add 93641 if you do DFT testing during the ICD generator replacement.
*** SubQ ICD
    - These are emerging technology codes that are temporary and will
      probably be changed in the next revision of the codes.
    - SubQ ICD codes are not tested for consistency by the code analyzer.
*** Upgrade/revision/extraction
    - This is the most complicated coding area. We will deal with some
      specific situations.
    - Note codes are arranged in order matching this help, not in
      numeric order.
**** TODO For this module
     - reaarange codes to match order of help
     - add missing codes, e.g. pocket revision and lead repair to module.
...
**** Removal of generator alone
     ...
     - Don't use these codes in conjunction with replacement codes.
...
*** Other procedure
    - These are miscellaneous EP procedures and coding is straightforward.
*** All EP codes
